  ...
  <div class="shadow p-4">
    <div class="mb-6">
      ...
      <ul class="p-4 mb-4">
        ...
        <li>
          Convert this plotted points into a heat map dependent on how long a
          device was in an area
        </li>
        <li>
      ...
      <ul class="p-4 mb-4">
        ...
        <li>
          deviceThings - An object of device things with key being id and value
          being thing object
        </li>
