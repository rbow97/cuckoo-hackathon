<template>
  <div class="shadow p-4">
    <div class="mb-6">
      <p class="text-3xl font-semibold mb-2 text-center">Zoomable Graph</p>

      <p>
        Congratulations you've chosen the task of creating a zoomable graph!
        Let's take a look at the tasks:
      </p>
      <ul class="p-4 mb-4">
        <li>Implement uPlot library</li>
        <li>Filter by dates, site, device, thing and name</li>
        <li>Implement a graph which can easily be zoomed in and out of</li>
  ...
  Give thing
  Give thing messages
  Probably hardcode thingId and thing metric so can be changed if needed
</template>
...
export default class ZoomableGraph extends Vue {
  // Properties
